                ...
                <nav class="header__navbar">
                    <div>
                        ...
                        <div class="topicArticle">
                            <ul>
                                <li><a href="DoiTra.php">Điều khoản và quy định</a></li>
                                <li><a href="answer2DoiTra.php">Quy trình đổi trả như thế nào?</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
                    ...
                    <div class="answerQuestion">
                        ...
                        <div>
                            <ol class="reason">
                                <li>Online
                                    <ul>
                                        <li>Gửi lại sách kèm hóa đơn thanh toán qua các phương tiện vận chuyển đến kho hàng tại Thị Trấn Nghèn, huyện Can Lộc, tỉnh Hà Tĩnh</li>
                                        <li>Chờ xác nhận của nhà sách</li>
                                        <li>Nhận tiền hoàn lại</li>
                                    </ul>
                                </li>
                                <li>Offline
                                    <ul>
                                        <li>Mang sách kèm hóa đơn thanh toán trực tiếp đến kho hàng tại Thị Trấn Nghèn, huyện Can Lộc, tỉnh Hà Tĩnh</li>
                                        <li>Chờ xác nhận của nhân viên tại nhà sách</li>
                                        <li>Nhận tiền hoàn lại</li>
                                    </ul>
                                </li>
                            </ol>
