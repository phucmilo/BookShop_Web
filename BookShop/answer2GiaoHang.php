            ...
            <div class="col-sm-6">
                <nav class="header__navbar">
                    <div class="answerQuestion">
                        <h1>Tôi cần làm gì khi gặp vấn đề vận chuyển?</h1>
                        <div>
                            <ul class="reason">
                                <li>Vui lòng kiểm tra lại đơn hàng của bạn</li>
                                <li>Liên lạc với đơn vị vận chuyển để biết thêm thông tin</li>
                                <li>
                                    <p>Đến văn phòng của Nhà sách Phúc tại Thị Trấn Nghèn, huyện Can Lộc, tỉnh Hà Tĩnh</p>
                                    <p>Hoặc gọi đến số điện thoại: 0866 959 757</p>
                                    <p>Hoặc gửi email cho chúng tôi: buitranbaophuc@gmail.com</p>
                                    <p>Chúng tôi rất vui lòng phục vụ quý khách hàng</p>
                                </li>
                            </ul>
                        </div>
                    </div>
