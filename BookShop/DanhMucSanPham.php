            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="breadcrumb">
                        <div class="container">
                            <a class="breadcrumb-item" href="ChiTietSP.php">Shop Phúc</a>
                    ...
                    <nav class="mainNav">
                        <ul>
                            <li class="selected"><a href="#">Sách Tiếng Việt</a>
                                <ul>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Bà mẹ - Em bé</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Chính trị - Pháp lý</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Công nghệ thông tin</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Giáo khoa - Giáo trình</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Học ngoại ngữ</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Khoa học - Kĩ thuật</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Sách Lịch sử</a>
                                    </li>
                                </ul>
                            </li>
                            <li><a href="#">English Books</a>
                                <ul>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Art Photography</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Biographies</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Dictionary</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">History</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Fiction_Literature</a>
                                    </li>
                                    <li><a href="DanhSachSanPhamTheoDanhMuc.php">Children's Book</a>
                                </ul>
                                </li>
                        </ul>
                    </nav>
                    ...
                    <section class="static about-sec">
                        <div class="container">
                            ...
                            <div class="recent-book-sec">
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="item">
                                            ...
                                            <h3><a href="ChiTietSP.php">Sách ABC</a></h3>
                                            <h6><span class="price">190000</span> / <a href="ChiTietSP.php">Mua</a></h6>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="item">
                                ...
                                <div class="btn-sec">
                                    <a href="DanhMucSanPham.php" class="btn orange-btn">Xem thêm</a>
                                </div>
                            </div>
